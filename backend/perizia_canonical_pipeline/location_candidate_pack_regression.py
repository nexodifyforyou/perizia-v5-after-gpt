...
def main() -> None:
    ...
    for case in load_cases():
        out = build_location_candidate_pack(case.case_key)
        rows.append({
            ...
            "artifact": (
                ...
                f"{case.case_key}/artifacts/location_candidate_pack.json"
            ),
        })

    fp = Path("/srv/perizia/_qa/canonical_pipeline/location_candidate_pack_regression_summary.json")
